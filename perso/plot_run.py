...
events = [
    {'Date': '2018-06-24', 'Title': "Course à Conflans-Sainte-Honorine (découverte de la CAP, victoire)", 'Description': "Mon père ne peut participer à une course pour raison médicale, il me confie donc son dossard et je gagne la course à la surprise générale avec des baskets trouées", 'Link': 'https://www.leparisien.fr/yvelines-78/conflans-sainte-honorine-la-culture-dans-la-course-24-06-2018-7790922.php'},
    {'Date': '2018-08-28', 'Title': "UTMB Jeune 2018", 'Description': "Après avoir remporté la course de Conflans, je décide de m'inscrire à la course jeune de l'UTMB, c'est dur ...", 'Link': 'https://utmb.world/fr/utmb-index/races/4365.utmb--ycc.2018'},
    {'Date': '2021-08-29', 'Title': "Course à Triel 2018 (victoire)", 'Description': "Entre mes deux années de prépa, je m'inscris à la course locale, que je remporte ...", 'Link': 'https://www.sartrouville-athle.fr/wp-content/uploads/2021/08/resultats-triel-13-km.pdf'},
    {'Date': '2022-04', 'Title': "Ekiden 2022", 'Description': "Fin des concours (écrit), je participe à un ekiden avec Ginette (ma prépa). Nous arrivons à la troisième place et j'ai le meilleur temps des participants sur 10km (environ 34 minutes).", 'Link': 'https://www.ekiden-platal.fr/'},
    {'Date': '2023-03', 'Title': "Ecotrail Paris", 'Description': "Première course que je prépare vraiment : vélo et côtes ! Je pars avec la tête de course mais une erreur de parcours au km 9 ... Je termine dans le top30, avec 8km de plus que les autres participants, et une remontada folle ! Beaucoup de déception ce jour-là, j'aurais pu faire top3 selon moi.", 'Link': 'https://www.ecotrailparis.com/fr/course-ecotrail-paris/trail-45-km'},
    {'Date': '2023-08', 'Title': "UTMB 2023", 'Description': "Je décide de participer à la course jeune de l'UTMB. Encore une fois, beaucoup de travail en côtes. Cette année le niveau est relevé, je termine à la 23e position, 2 places derrière Baptiste Cartieaux, un AS chez les jeunes !", 'Link': 'https://www.betrail.run/race/utmb/2023/15km-7811565/results#d'},
    {'Date': '2023-10-22', 'Title': "Marathon de Rennes", 'Description': "Pour mon anniversaire (22 ans) je décide de faire un marathon sans préparation. Il y a Lyon ou Rennes le 22 octobre, j'opte pour Rennes et m'en tire avec un 2h33 tout plaisir !", 'Link': 'https://www.breizhchrono.com/detail-de-la-course/marathonvertrennesschoolofbusiness-lemarathonvertrennes-2023-16622'},
    {'Date': '2023-11', 'Title': "Semi de Boulogne (élément déclencheur)", 'Description': "Après avoir participé à une séance collective du TRC, je décide de partir sur le semi de Boulogne sans véritable préparation mais avec la barre des 1h10 en tête. Malheureusement (sans grande surprise), j'explose : 1h11. Je suis déçu et frustré. Ca y est, la machine est en route, à partir de maintenant je vais me donner le moyen d'atteindre les objectifs que je me suis fixé.", 'Link': ''},
    {'Date': '2023-12', 'Title': "10km de Issy", 'Description': "Je participe au 10km de Issy, j'ai commencé à m'entraîner sérieusement et passe de belles séances. Je viens pour le sub 32 et repars avec un 32:10. Fin de course mitigée, j'en ai encore dans le sac donc un peu de frustration ... Ce n'est que partie remise !", 'Link': ''},
    {'Date': '2024-01', 'Title': "Prom'Classic", 'Description': "Je participe à la prom'classic. Ambiance de fou furieux, entraînement de fou furieux. J'ai tout pour reussir ! J'en ai peut-être trop fait à l'entraînement car veille de la course je tombe dans les pommes lors de mes accels'. J'ai pas fait le déplacement pour rien, je m'aligne donc sur la ligne de départ. Résultat : 31'06. Je suis content, mais j'ai encore les crocs !", 'Link': ''},
    {'Date': '2024-03', 'Title': "France de Cross et Semi de Lille", 'Description': "Après avoir écouté le podcast de Runnix sur Etienne Daguinos, je décide de tenter l'enchaînement France de cross -> Semi de Lille, qui marche plutôt bien ! 108e position aux France de cross sur un parcours pas facile et un joli 1h05'42 sur semi ... La progression continue !", 'Link': ''},
    {'Date': '2024-04', 'Title': "10km de Valenciennes", 'Description': "Après Lille, je n'ai plus qu'un objectif en tête : validé le fameux sub 30. Je passe de très belles séances, m'entraîne bien, récupère bien. Je décide donc de m'aligner sur les 10km de Valenciennes. Je fais 30:15 (passage au 5km en 14:36), joli popcorn ! Je ne perds jamais, j'apprends.", 'Link': ''},
    {'Date': '2024-05', 'Title': "Début de la saison de piste", 'Description': "Début de la saison de piste (que je n'ai pas envie de faire). J'essaye de me motiver car on me dit que ça va me faire progresser sur la route. J'execute donc. Premier tour des interclubs, pop corn total sur 3000m avec un 8:39. Beaucoup de déception ... Je commence à avoir du mal à m'entraîner, je perds la motivation. Fin du mois, 5000m de St Maur que je remporte en 14:40. Je suis toujours frustré.", 'Link': ''},
    {'Date': '2024-06', 'Title': "Piste acte 2", 'Description': "Je m'entraîne tant bien que mal, je passe quelques séances. Mais je sens que je commence à être fatigué. Je vise 14:10 sur 5000m et je pense que j'en ai les capacités. Malheureusement, je ne parviens pas à efffectuer ce chrono et réalise deux fois 14:30 (Cergy puis FAST5000).", 'Link': ''},
    {'Date': '2024-08', 'Title': "Bilan de ma première saison", 'Description': "Je décide de faire une coupure sur une partie de juillet et août afin de me régénérer. J'ai beaucoup d'objectifs en tête mais si je retiens une chose de ma saison d'athlé, c'est que j'ai aussi besoin des études pour être stimulé. J'ai très hâte de débuter mon master 2 au MVA à la rentrée de septembre et souhaite concilier mon cursus académique avec mes aventures sportives.", 'Link': ''},
]
...
# Créer une série temporelle pour le volume d'entraînement
dates = pd.date_range(start=training_df['Start Date'].min(), end=training_df['End Date'].max(), freq='W')
volumes = []
for date in dates:
    volume = None
    for _, row in training_df.iterrows():
        if row['Start Date'] <= date <= row['End Date']:
            volume = row['Volume (km/week)']
            break
    volumes.append(volume)

training_series = pd.Series(volumes, index=dates, name='Volume (km/week)')

# Créer le graphique interactif
fig = px.line(training_series, x=training_series.index, y=training_series.values, labels={'x': 'Date', 'y': 'Volume (km/week)'}, title='Évolution de mon Volume d\'Entraînement')

# Ajouter les événements sur le graphique
